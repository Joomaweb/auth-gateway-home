...
import { LayoutDashboard, Package, ShoppingCart, Users, MessageSquare, Settings, ArrowLeft, Menu, Webhook, Tag, BookOpen, CreditCard, FileText, Palette, TrendingUp, Ticket, Eye } from "lucide-react";
...
export function AdminLayout({ children }: { children: ReactNode }) {
  ...
  const items = [
    ...
    { to: "/admin/visits", label: "קאונטר כניסות", icon: Eye },
    ...
    { to: "/admin/legal", label: t("admin.legal"), icon: FileText },
