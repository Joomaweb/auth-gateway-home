...
import { Users, Globe, Eye, Clock } from "lucide-react";
...
function AdminVisits() {
  ...
  const perUser = aggregate(visits, (v) => v.user_id ?? "אורח");
  ...
  const cards = [
    ...
    { label: "משתמשים ייחודיים", value: uniqueUsers, icon: Users },
  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <p className="text-sm text-muted-foreground">מתעדכן בזמן אמת</p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <AggregateCard title="לפי משתמש" rows={perUser} />
