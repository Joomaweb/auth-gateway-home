...
export const THEMES: ThemePreset[] = [
  ...
  },
  {
    ...
    description: "Clean white storefront with vivid coral CTAs — modern fashion e-commerce",
    layout: "top-classic",
    fontUrl: "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&family=Playfair+Display:wght@600;700&display=swap",
    vars: {
      radius: "0.375rem",
      ...
      "sidebar-ring": "oklch(0.68 0.19 30)",
    },
  },
];
